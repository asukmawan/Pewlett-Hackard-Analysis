...
-- Retrieve the number of employees eligibile for mentorship by their current title
...
-- The Current Employees by Title
SELECT e.emp_no,
	e.first_name,
	e.last_name,
	t.title,
...
-- Create a new table containing only number of current employees and their titles
